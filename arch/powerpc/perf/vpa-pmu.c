 ...
 *
 * Copyright 2024 Kajol Jain, IBM Corporation.
...
GENERIC_EVENT_ATTR(l1_to_l2_lat,  L1_TO_L2_CS_LAT);
GENERIC_EVENT_ATTR(l2_to_l1_lat,  L2_TO_L1_CS_LAT);
GENERIC_EVENT_ATTR(l2_runtime_agg, L2_RUNTIME_AGG);

static struct attribute *vpa_pmu_events_attr[] = {
	GENERIC_EVENT_PTR(L1_TO_L2_CS_LAT),
	GENERIC_EVENT_PTR(L2_TO_L1_CS_LAT),
	GENERIC_EVENT_PTR(L2_RUNTIME_AGG),
	NULL
};
...
MODULE_AUTHOR("Madhavan Srinivasan");
MODULE_LICENSE("GPL");
